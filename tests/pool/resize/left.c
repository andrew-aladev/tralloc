...
{
    size_t data_1_user_length = sizeof ( _tralloc_pool_fragment ) + sizeof ( uint8_t ) * 5;
    ...
    if (
        ...
        data_2_child->prev   != NULL ||
        data_2_child->next   != NULL ||
        data_2_child->length != data_2_length + data_1_length + data_3_length - sizeof ( _tralloc_pool_fragment )
    ) {
        return TRALLOC_FALSE;
    }
    ...
    if (
        ...
        data_2_child->prev   != NULL ||
        data_2_child->next   != NULL ||
        data_2_child->length != data_2_length + data_1_length + data_3_length
    ) {
        return TRALLOC_FALSE;
    }
