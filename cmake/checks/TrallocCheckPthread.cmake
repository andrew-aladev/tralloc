function (tralloc_check_pthread)
    ...
    set (NAME "tralloc_check_pthread")
    
    try_compile (CHECK_PTHREAD_RESULT ${BINARY_DIR} ${SOURCE_DIR} ${NAME}
        CMAKE_FLAGS
            "-DCMAKE_C_FLAGS=${CMAKE_C_FLAGS} ${TRALLOC_VERBOSE_CFLAGS} ${TRALLOC_WERROR_CFLAGS} -pthread"
    ...
    if (${CHECK_PTHREAD_RESULT})
        ...
        set (TRALLOC_PTHREAD_CFLAGS "-pthread" CACHE STRING "pthread cflags")
        set (TRALLOC_PTHREAD_LDLAGS "-pthread" CACHE STRING "pthread ldflags")
        message (STATUS "Check for pthread support - yes")
        return ()
    endif ()
    
    set (TRALLOC_HAVE_PTHREAD false CACHE STRING "Status of pthread support")
    set (TRALLOC_PTHREAD_CFLAGS "" CACHE STRING "pthread cflags")
    set (TRALLOC_PTHREAD_LDLAGS "" CACHE STRING "pthread ldflags")
