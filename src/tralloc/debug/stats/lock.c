...
static _tralloc_debug_stats_lock _tralloc_debug_stats_chunks_overhead_length_lock = PTHREAD_RWLOCK_INITIALIZER;
static _tralloc_debug_stats_lock _tralloc_debug_stats_chunks_length_lock          = PTHREAD_RWLOCK_INITIALIZER;
...
static _tralloc_debug_stats_lock _tralloc_debug_stats_chunks_overhead_length_lock = PTHREAD_MUTEX_INITIALIZER;
static _tralloc_debug_stats_lock _tralloc_debug_stats_chunks_length_lock          = PTHREAD_MUTEX_INITIALIZER;
...
static _tralloc_debug_stats_lock _tralloc_debug_stats_chunks_overhead_length_lock;
static _tralloc_debug_stats_lock _tralloc_debug_stats_chunks_length_lock;
...
void _tralloc_debug_stats_lock_constructor ()
{
    if (
        ...
        pthread_spin_init ( &_tralloc_debug_stats_chunks_overhead_length_lock, 0 ) != 0 ||
        pthread_spin_init ( &_tralloc_debug_stats_chunks_length_lock, 0 )          != 0
    ) {
#       if defined ( TRALLOC_DEBUG_LOG )
        fprintf (
            stderr,
...
void _tralloc_debug_stats_lock_destructor ()
{
    if (
        pthread_spin_destroy ( &_tralloc_debug_stats_chunks_count_lock )           != 0 ||
        pthread_spin_destroy ( &_tralloc_debug_stats_chunks_overhead_length_lock ) != 0 ||
        pthread_spin_destroy ( &_tralloc_debug_stats_chunks_length_lock )          != 0
    ) {
#       if defined ( TRALLOC_DEBUG_LOG )
        fprintf (
            stderr,
...
{
    return _tralloc_rdlock_debug_stats ( &_tralloc_debug_stats_chunks_count_lock );
}

tralloc_error _tralloc_debug_stats_wrlock_chunks_count ()
{
    return _tralloc_wrlock_debug_stats ( &_tralloc_debug_stats_chunks_count_lock );
}

tralloc_error _tralloc_debug_stats_unlock_chunks_count ()
{
    return _tralloc_unlock_debug_stats ( &_tralloc_debug_stats_chunks_count_lock );
}


tralloc_error _tralloc_debug_stats_rdlock_chunks_overhead_length ()
{
    return _tralloc_rdlock_debug_stats ( &_tralloc_debug_stats_chunks_overhead_length_lock );
}

tralloc_error _tralloc_debug_stats_wrlock_chunks_overhead_length ()
{
    return _tralloc_wrlock_debug_stats ( &_tralloc_debug_stats_chunks_overhead_length_lock );
}

tralloc_error _tralloc_debug_stats_unlock_chunks_overhead_length ()
{
    return _tralloc_unlock_debug_stats ( &_tralloc_debug_stats_chunks_overhead_length_lock );
}


tralloc_error _tralloc_debug_stats_rdlock_chunks_length ()
{
    return _tralloc_rdlock_debug_stats ( &_tralloc_debug_stats_chunks_length_lock );
}

tralloc_error _tralloc_debug_stats_wrlock_chunks_length ()
{
    return _tralloc_wrlock_debug_stats ( &_tralloc_debug_stats_chunks_length_lock );
}

tralloc_error _tralloc_debug_stats_unlock_chunks_length ()
{
    return _tralloc_unlock_debug_stats ( &_tralloc_debug_stats_chunks_length_lock );
}
