...
{
    return _tralloc_rdlock_debug_stats ( &_tralloc_debug_stats_overhead_length_lock );
}

tralloc_error _tralloc_debug_stats_wrlock_overhead_length ()
{
    return _tralloc_wrlock_debug_stats ( &_tralloc_debug_stats_overhead_length_lock );
}

tralloc_error _tralloc_debug_stats_unlock_overhead_length ()
{
    return _tralloc_unlock_debug_stats ( &_tralloc_debug_stats_overhead_length_lock );
}
