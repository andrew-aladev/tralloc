...
static const char _ERROR_REQUIRED_ARGUMENT_IS_NULL [] = "required argument is NULL";
static const char _ERROR_MALLOC_FAILED             [] = "malloc failed";
static const char _ERROR_CALLOC_FAILED             [] = "calloc failed";
static const char _ERROR_REALLOC_FAILED            [] = "realloc failed";
static const char _ERROR_OPEN_DESCRIPTOR_FAILED    [] = "open descriptor failed";
static const char _ERROR_CLOSE_DESCRIPTOR_FAILED   [] = "close descriptor failed";
static const char _ERROR_PRINTF_FAILED             [] = "printf failed";

static const char _ERROR_CHILD_EQUALS_PARENT   [] = "child equals parent";
static const char _ERROR_CHILD_HAS_SAME_PARENT [] = "child has same parent";

#if defined(TRALLOC_EXTENSIONS)
static const char _ERROR_NO_SUCH_EXTENSION [] = "no such extension";
#endif

#if defined(TRALLOC_POOL)
static const char _ERROR_POOL_CANT_BE_REALLOCATED [] = "pool cant be reallocated";
#endif

#if defined(TRALLOC_UTILS_BUFFER)
static const char _ERROR_UTILS_BUFFER_OVERFLOW [] = "overflow of buffer util";
#endif

#if defined(TRALLOC_THREADS)
static const char _ERROR_MUTEX_FAILED    [] = "mutex failed";
static const char _ERROR_SPINLOCK_FAILED [] = "spinlock failed";
