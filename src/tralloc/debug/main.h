...
typedef tralloc_error ( * _tralloc_debug_callback_before_free_subtree ) ( void * user_data, _tralloc_chunk * chunk );
...
tralloc_error _tralloc_debug_set_callbacks (
    ...
    _tralloc_debug_callback_before_free_subtree before_free_subtree,
