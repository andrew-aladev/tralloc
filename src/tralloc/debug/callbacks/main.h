...
typedef tralloc_error ( * tralloc_debug_callback_before_add ) ( void * data, _tralloc_chunk_prototype * prototype );
...
tralloc_error _tralloc_debug_callback_before_add_chunk ( _tralloc_chunk_prototype * prototype );
