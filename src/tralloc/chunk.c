...
extern inline tralloc_chunk * tralloc_usual_process_new_chunk  ( tralloc_chunk * chunk, const tralloc_context * parent_context );
...
extern inline uint8_t         tralloc_usual_process_free_chunk ( tralloc_chunk * chunk );
