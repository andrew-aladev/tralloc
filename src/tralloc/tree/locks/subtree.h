...
#if !defined ( TRALLOC_TREE_LOCKS_SUBTREE_H )
#define TRALLOC_TREE_LOCKS_SUBTREE_H

#include "../../types.h"
#include "../../macro.h"

#undef _TRALLOC_INLINE
#if defined ( _TRALLOC_INCLUDED_FROM_TREE_LOCKS_SUBTREE_C )
...
typedef struct _tralloc_subtree_lock_type {
