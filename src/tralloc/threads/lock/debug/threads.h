...
#if !defined ( TRALLOC_THREADS_LOCK_DEBUG_THREADS_H )
#define TRALLOC_THREADS_LOCK_DEBUG_THREADS_H

#include "../../../types.h"
#include "../../../macro.h"

#undef _TRALLOC_INLINE
#if defined ( _TRALLOC_INCLUDED_FROM_THREADS_LOCK_DEBUG_THREADS_C )
